...
class mandob_accept_orders extends StatefulWidget {
  @override
  _mandob_accept_ordersState createState() => _mandob_accept_ordersState();
}

class _mandob_accept_ordersState extends State<mandob_accept_orders> {
              ...
              Padding(
                ...
                child: Center(
                  child: Container(
                    ...
                    child: Center(child: InkWell(child: new Text("التواصل مع العميل",style: TextStyle(color: Colors.white),),onTap: ()=>{
